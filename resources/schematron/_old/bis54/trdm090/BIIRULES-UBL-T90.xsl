...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:saxon="http://saxon.sf.net/" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:ubl="urn:oasis:names:specification:ubl:schema:xsd:Tender-2" cbc:dummy-for-xmlns="" cac:dummy-for-xmlns="" ubl:dummy-for-xmlns="" version="2.0"><!--Implementers: please note that overriding process-prolog or process-root is 
...
<!--SCHEMA SETUP-->
<xsl:template match="/">
		<svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T90 bound to UBL" schemaVersion="">
			<xsl:comment>
...
<xsl:choose>
			...
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:TendererParty/cac:PartyIdentification/cbc:ID)">
...
<xsl:choose>
			...
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:ContractingParty/cac:Party/cac:PartyIdentification/cbc:ID)">
...
<xsl:choose>
			...
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(count(timezone-from-time(cbc:IssueTime)) &gt; 0)">
...
<xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
			<xsl:when test="(cac:DocumentReference[cbc:DocumentTypeCode='310']/cbc:ID) or not(cac:DocumentReference/cbc:DocumenTypeCode = '310')"/>
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:DocumentReference[cbc:DocumentTypeCode='310']/cbc:ID) or not(cac:DocumentReference/cbc:DocumenTypeCode = '310')">
		...
		<!--ASSERT -->
<xsl:choose>
			<xsl:when test="(cac:DocumentReference[cbc:DocumentTypeCode='310']/cbc:VersionID)  or not(cac:DocumentReference/cbc:DocumenTypeCode = '310')"/>
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:DocumentReference[cbc:DocumentTypeCode='310']/cbc:VersionID) or not(cac:DocumentReference/cbc:DocumenTypeCode = '310')">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:DocumentReference" priority="1003" mode="M6">
...
<xsl:choose>
			...
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cbc:DocumentDescription)">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cac:DocumentReference/cac:Attachment" priority="1002" mode="M6">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//cac:DocumentReference/cac:Attachment"/>

		<!--ASSERT -->
<xsl:choose>
			<xsl:when test="(cac:ExternalReference/cbc:FileName)"/>
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:ExternalReference/cbc:FileName)">
...
<xsl:choose>
			...
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:ExternalReference/cbc:DocumentHash)">
...
<xsl:choose>
			...
			<xsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:ExternalReference/cbc:HashAlgorithmMethod)">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="//cbc:DocumentTypeCode" priority="1000" mode="M6">
...
<!--PATTERN CodesT90-->
	...
	<!--RULE -->
<xsl:template match="cac:Country//cbc:IdentificationCode" priority="1002" mode="M7">
