...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        ...
        <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:trns:t018:1.0'"
                flag="fatal" id="PEPPOL-T018-R013">Element 'cbc:CustomizationID' MUST contain value 'urn:fdc:peppol.eu:prac:trns:T018:1.0'.</assert>
        </rule>

        <rule context="/ubl:ApplicationResponse/cbc:ProfileID">
            <assert test="normalize-space(text()) = 'urn:fdc:peppol.eu:prac:bis:p010:1.0'"
                    flag="fatal" id="PEPPOL-T018-R014">Element 'cbc:ProfileID' MUST contain value 'urn:fdc:peppol.eu:prac:bis:p010:1.0'.</assert>
        </rule>
