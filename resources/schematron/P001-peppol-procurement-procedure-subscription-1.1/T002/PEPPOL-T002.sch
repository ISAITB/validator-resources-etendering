...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <pattern>
        ...
        <rule context="ubl:ExpressionOfInterestResponse/cbc:CustomizationID">
            <assert id="PEPPOL-T002-R002" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:trns:t002:1.1'">[PEPPOL-T002-R002] CustomizationID value MUST be 'urn:fdc:peppol.eu:prac:trns:t002:1.1'</assert>
        ...
        <rule context="ubl:ExpressionOfInterestResponse/cbc:ProfileID">
            <assert id="PEPPOL-T002-R004" flag="fatal" test="normalize-space(.) = 'urn:fdc:peppol.eu:prac:bis:p001:1.1'">[PEPPOL-T002-R004] ProfileID value MUST be 'urn:fdc:peppol.eu:prac:bis:p001:1.1'</assert>
